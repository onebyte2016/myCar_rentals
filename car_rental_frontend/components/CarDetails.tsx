        ...
        onClose={closeModal}>
            ...
            transition-all flex flex-col gap-5">
                ...
                <div className='flex-1 flex flex-col gap-3'>
                    <div className='relative w-full h-50 bg-pattern
                    ...
                    className='object-contain'
                        />
                    {/* <Image src={generateCarImageUrl(car,'angle')} alt='car 
                    model' fill priority
                    className='object-contain'/>  */}
                    </div>
                    ...
                    bg-primary-blue-100 rounded-lg'>
                        {/* <img
                            ...
                            height={400}
                            /> */}
                    <img src={generateCarImageUrl(car,'33')} alt='car 
                    model'
                    className='object-contain'/>
                        </div>
                        <div className='flex-1 relative w-full h-24
                ...
                <div className='flex-1 flex flex-col gap-2'>
                    ...
                    >
                        ...
                        {typeof value === "object" && value !== null
                            ? value.image ?? JSON.stringify(value)
                            : String(value)}
                        </p>
                    </div>
                    ))}
